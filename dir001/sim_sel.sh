...
mkdir daf; mv *.daf daf/
mkdir true_ne; mv *.true_ne true_ne/
rm -rf 3_* *trees hmmibdinput.txt hap-ibd.jar sample_name_map.txt  sample_order.txt
rm -rf posseleff_simulations/